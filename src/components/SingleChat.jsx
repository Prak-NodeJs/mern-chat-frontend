...
const SingleChat = ({ fetchAgain, setFetchAgain }) => {
    ...
    const fetchMessages = async () => {
        ...
        try {
            ...
            setLoading(true)
            const { data } = await axios.get(`https://chat-backend-api-vtlb.onrender.com/api/message/${selectedChat._id}`, config)
    ...
    const deleteMessage = async (m) => {
        try {
            ...
            setLoading(true)
            await axios.delete(`https://chat-backend-api-vtlb.onrender.com/api/message/${m._id}`, config)
            fetchMessages()
            setLoading(false)
    ...
    const editMessage = async () => {
        try {
            if (newMessage) {
                ...
                setLoading(true)
                await axios.put(`https://chat-backend-api-vtlb.onrender.com/api/message/${editing._id}`, {
                    content: newMessage
                }, config)
                fetchMessages()
                setLoading(false)
    ...
    const sendMessage = async (event) => {
        if ( newMessage || file) {
            ...
            try {
                ...
                const { data } = await axios.post(`https://chat-backend-api-vtlb.onrender.com/api/message`, messageData, config)
    ...
    const sendReply = async (event) => {
        if (newMessage || file) {
            ...
            try {
                ...
                const { data } = await axios.post(`https://chat-backend-api-vtlb.onrender.com/api/reply/message/${replying._id}`, messageData, config)
